...
public class LessonsController {
    ...
    public ResponseEntity<Object> findLessonIntoModule(@PathVariable UUID moduleId, @PathVariable UUID lessonId) {
    ...
    public ResponseEntity<Object> saveLesson(@PathVariable UUID moduleId,
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(lessonModel);
    }
